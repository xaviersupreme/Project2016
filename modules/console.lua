-- Not created by me (not sure who made this)
-- Meant to be used for my 2016 CoreGui remake
...
if getrenv then require = getrenv().require end
...
do
	...
	function DeveloperConsole.GetPermissions()
		...
		permissions.ClientCodeExecutionEnabled = true
		permissions.ServerCodeExecutionEnabled = false
		permissions.MayViewServerLog = false
		permissions.MayViewClientLog = true
		permissions.MayViewServerStats = false
		permissions.MayViewServerMemory = false
		permissions.MayViewServerScripts = false
		permissions.MayViewServerJobs = false
		...
		permissions.MayViewContextActionBindings = false
